...
class AddNewMenuItemPopUpWidget extends StatefulWidget {
  final Function refreshParent;
  const AddNewMenuItemPopUpWidget({Key? key, required this.refreshParent})
      : super(key: key);

  @override
  State<AddNewMenuItemPopUpWidget> createState() =>
      _AddNewMenuItemPopUpWidgetState();
}

class _AddNewMenuItemPopUpWidgetState extends State<AddNewMenuItemPopUpWidget> {
